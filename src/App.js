          ...
          {boatLoad => (
            <div className='App'>
              ...
              <div className='content'>
                <p>
                  Rent up to 4 banana boats. Each boat can have up to 6 people.
                  Bob's Banana Boat will also provide fresh banana's for your
                  hungry riders so just let us know how many bananas your party will need.
                </p>
                {boatCards}
                <div className='split'>
                  <p>
